...
class Transaction
{
	...
	private synchronized boolean acquireLock(ResourceAccess resourceAccess)
	{
		...
		try {
			...
			//if it should use edge chasing a thread will start that will send a list of edges from one server to antoher, starting with the owner of this transaction
